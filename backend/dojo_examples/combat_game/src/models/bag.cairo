...
mod tests {
    ...
    fn test_bag_initialization() {
        ...
        let bag = Bag { bag_id: bag_id, player: player_id, quantity: quantity };
    ...
    fn test_bag_with_different_item_types() {
        ...
        let weapon_bag = Bag { bag_id: 1, player: address, quantity: 1 };

        let armor_bag = Bag { bag_id: 2, player: address, quantity: 1 };

        let potion_bag = Bag { bag_id: 3, player: address, quantity: 5 };
    }
    ...
    fn test_zero_quantity_bag() {
        ...
        let empty_bag = Bag { bag_id: 1, player: address, quantity: 0 };
