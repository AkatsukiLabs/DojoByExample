...
fn test_status_condition_to_felt252() {
    ...
    assert_eq!(
        paralyzed.into(), 2_felt252, "StatusCondition::Paralyzed should convert to 2_felt252",
    );
...
fn test_u8_to_status_condition_valid() {
    ...
    assert_eq!(
        one.into(), StatusCondition::Poisoned, "1 should convert to StatusCondition::Poisoned",
    );
    assert_eq!(
        two.into(), StatusCondition::Paralyzed, "2 should convert to StatusCondition::Paralyzed",
    );
    assert_eq!(
        three.into(), StatusCondition::Asleep, "3 should convert to StatusCondition::Asleep",
    );
    assert_eq!(
        four.into(), StatusCondition::Confused, "4 should convert to StatusCondition::Confused",
    );
    ...
    assert_eq!(
        seven.into(), StatusCondition::Cursed, "7 should convert to StatusCondition::Cursed",
    );
}
...
fn test_u8_to_status_condition_invalid() {
    ...
    assert_eq!(
        hundred.into(), StatusCondition::None, "100 should default to StatusCondition::None",
    );
    assert_eq!(
        two_fifty_five.into(), StatusCondition::None, "255 should default to StatusCondition::None",
    );
    assert_eq!(
        two_hundred.into(), StatusCondition::None, "200 should default to StatusCondition::None",
    );
}
